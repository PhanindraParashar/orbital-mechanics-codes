...
ImpDates = [PerigeeEarth,Sankranti,Aries,VernalEquinox,AutumnalEquinox,SummerSolstice,WinterSolstice,ApogeeEarth,TestDate]
...
for i in ImpDates:
    ...
    print(A,"     ",i)
    #print(A,"     ",Angle_Aries,"     " ,k,"   ",i,"     days   ",D)

#print(Degree_Minutes(174.86821901602067))s

dd1 = '1-1-2018 21:56:00'
dd2 = '30-1-2018 9:55:00'
print(Delta_D(dd1,PerigeeEarth))
print(Delta_D(dd1,dd2))

"""
dd1 = '1-1-2018 21:56:00'
dd2 = '30-1-2018 9:55:00'
dd3 = '27-2-2018 14:50:00'
dd4 = '26-3-2018 17:19:00'
dd5 = '20-4-2018 14:46:00'
dd6 = '17-5-2018 21:07:00'
DD = [dd1,dd2,dd3,dd4,dd5,dd6]
Avg = []
for i in range(len(DD)):
    if i < len(DD):
        delta = Delta_D(DD[i],DD[i+1])
    print(delta)
    Avg.append(delta)
"""
...
def Angle_Dates_Perigee_degree_trial(Date):
    PerigeeEarth = '3-1-2018 11:05:00'
    days = Delta_D(PerigeeEarth,Date)
    AreaSwept = Area_Time_Ratio*days
    while AreaSwept > np.pi:
